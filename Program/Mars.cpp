...
Map::Map():Map(0, 0){}      // Default Constructor

Map::Map(int Y, int X)      // Constructor To Set dimY and dimX Into Dimensions Given By User
{
    this->dimY = Y;
    this->dimX = X;
}

Map::~Map()                 // Destructor Free Memory Occupied By Pointer
{
...
void Map::goldScatter()
{
    ...
    // cout << "Ditributing Gold" << endl;
    // cout << gold << " : " << dimX*dimY - 1 << endl;
